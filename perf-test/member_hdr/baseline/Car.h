...
public:
    ...
    #pragma clang diagnostic pop
        ...
        friend std::ostream& operator<<(std::ostream& builder, FuelFigures& writer)
        {
            builder << '{';
            ...
            builder << ", ";
            builder << "\"usageDescription\": ";
            builder << '"' <<
                writer.getUsageDescriptionAsString() << '"';
...
#pragma clang diagnostic pop
    ...
    #pragma clang diagnostic pop
        ...
        #pragma clang diagnostic pop
            ...
            friend std::ostream& operator<<(std::ostream& builder, Acceleration& writer)
            {
                builder << '{';
                //Token{signal=ENCODING, name='uint16', referencedName='null', description='null', id=-1, version=0, deprecated=0, encodedLength=2, offset=0, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=UINT16, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='null'}}
                builder << "\"mph\": ";
...
public:
    ...
    #pragma clang diagnostic pop
        ...
        friend std::ostream& operator<<(std::ostream& builder, PerformanceFigures& writer)
        {
            builder << '{';
            ...
            builder << ", ";
            {
                ...
                writer.acceleration().forEach([&](Acceleration& acceleration)
                {
                    if (atLeastOne)
                        builder << ',';
                    atLeastOne = true;
...
#pragma clang diagnostic pop
    ...
    friend std::ostream& operator<<(std::ostream& builder, const Car& _writer)
    {
        Car writer(_writer.m_buffer, _writer.m_offset,
            _writer.m_bufferLength, _writer.sbeBlockLength(), _writer.m_actingVersion);
        builder << '{';
        builder << "\"Name\": \"Car\", ";
        builder << "\"sbeTemplateId\": ";
        ...
        //Token{signal=ENCODING, name='someNumbers', referencedName='null', description='null', id=-1, version=0, deprecated=0, encodedLength=16, offset=12, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=UINT32, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='null'}}
        builder << ", ";
        builder << "\"someNumbers\": ";
        builder << '[';
        if (writer.someNumbersLength() > 0)
        {
            for (size_t i = 0; i < writer.someNumbersLength(); i++)
            {
                if (i)
                    builder << ',';
        ...
        //Token{signal=ENCODING, name='VehicleCode', referencedName='null', description='null', id=-1, version=0, deprecated=0, encodedLength=6, offset=28, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=CHAR, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='ASCII', epoch='null', timeUnit=null, semanticType='null'}}
        builder << ", ";
        builder << "\"vehicleCode\": ";
        builder << '"';
        for (size_t i = 0;
            i < writer.vehicleCodeLength() && writer.vehicleCode(i) > 0;
            i++)
        {
            builder << (char)writer.vehicleCode(i);
        }
        builder << '"';
        ...
        //Token{signal=BEGIN_ENUM, name='Model', referencedName='null', description='null', id=-1, version=0, deprecated=0, encodedLength=1, offset=35, componentTokenCount=5, encoding=Encoding{presence=REQUIRED, primitiveType=CHAR, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='null'}}
        builder << ", ";
        builder << "\"discountedModel\": ";
        builder << '"' << writer.discountedModel() << '"';

        //Token{signal=BEGIN_COMPOSITE, name='Engine', referencedName='null', description='null', id=-1, version=0, deprecated=0, encodedLength=10, offset=35, componentTokenCount=21, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='null', timeUnit=null, semanticType='null'}}
        builder << ", ";
        builder << "\"engine\": ";
        ...
        builder << ", ";
        {
            bool atLeastOne = false;
            builder << "\"fuelFigures\": [";
            writer.fuelFigures().forEach([&](FuelFigures& fuelFigures)
            {
                if (atLeastOne)
                    builder << ',';
                atLeastOne = true;
        ...
        builder << ", ";
        {
            ...
            writer.performanceFigures().forEach([&](PerformanceFigures& performanceFigures)
            {
                if (atLeastOne)
                    builder << ',';
                atLeastOne = true;
        ...
        builder << ", ";
        builder << "\"activationCode\": ";
        builder << '"' <<
            writer.getActivationCodeAsString() << '"';

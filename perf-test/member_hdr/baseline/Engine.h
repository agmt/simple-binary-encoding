...
public:
    ...
    friend std::ostream& operator<<(std::ostream& builder, Engine& writer)
    {
        builder << '{';
        ...
        builder << ", ";
        builder << "\"numCylinders\": ";
        builder << +writer.numCylinders();
        ...
        builder << ", ";
        builder << "\"manufacturerCode\": ";
        builder << '"';
        for (size_t i = 0;
            i < writer.manufacturerCodeLength() && writer.manufacturerCode(i) > 0;
            i++)
        {
            builder << (char)writer.manufacturerCode(i);
        }
        builder << '"';
        ...
        builder << ", ";
        builder << "\"boosterEnabled\": ";
        builder << '"' << writer.boosterEnabled() << '"';
